...
> Note: I did not use AI to write this documentation. This documentation is more intended as a way to verify my schematics/PCB layout before I waste $150 on a paperweight PCB than a public-facing documentation resource, but it can work as both if needed. :)